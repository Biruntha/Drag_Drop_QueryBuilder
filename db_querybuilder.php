...
require_once 'libraries/DbSearchBuilder.class.php';
...
$scripts->addFile('js/jquery/jquery-1.9.1.min.js');
$scripts->addFile('/jquery/redips-drag-min.js');
$scripts->addFile('script.js');
$scripts->addFile('script1.js');
...
$url_query .= '&amp;goto=db_querybuilder.php';
$url_params['goto'] = 'db_querybuilder.php';

// Create a database search instance
$db_search = new PMA_DbSearchBuilder($GLOBALS['db']);
