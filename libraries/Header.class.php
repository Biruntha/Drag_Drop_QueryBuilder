...
class PMA_Header
{
    ...
    private function _addDefaultScripts()
    {
		...
		//$this->_scripts->addFile('jquery/jquery-1.9.1.min.js');
		...
		/**************/
		$this->_scripts->addFile('jquery/redips-drag-min.js');
		...
		//$this->_scripts->addFile('../style.css');
		//$this->_scripts->addFile('../style1.css');
		//$this->_scripts->addFile('script.js');
		//$this->_scripts->addFile('script1.js');
    ...
    private function _getLinkTags()
    {
        ...
        if ($this->_isPrintView) {
			...
			$retval .= '<script src="/jquery/jquery-1.9.1.min.js" /></script>';
			$retval .= '<script type="text/javascript" src="script.js" /></script>';
			$retval .= '<script type="text/javascript" src="script1.js" /></script>';
			$retval .= '<script src="/jquery/redips-drag-min.js" /></script>';
			$retval .= '<link rel="stylesheet" type="text/css" href="'. $basedir .'style.css" />';
			$retval .= '<link rel="stylesheet" type="text/css" href="'. $basedir.'style1.css" />';
